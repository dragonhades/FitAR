...
namespace Assets.Scripts.Fitbit
{
    ...
    public class FitBitAPI : MonoBehaviour
    {
        ...
        /// </summary>
        private const string _consumerSecret = "b2ad9f84db8ca20d981c6cf1f0435029";
        private const string _clientId = "22CN2T";
        private const string _callbackURL = "https://localhost";
